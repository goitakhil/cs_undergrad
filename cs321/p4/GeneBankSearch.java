...
/**
 * Reads the string sequences in a given query file and searches a given
 * BTree file to see if there are any matches.
 *
 * @author Stacy Black
 */
public class GeneBankSearch {
	...
	public static void main(String[] args) throws IOException {
		...
		file = new DataStore(btreeFilename);			//access to the BTree file
	...
	/**
	 * Goes through the query file line by line, and prints output along
	 * the way (such as the query line number, the query itself, and its
	 * frequency.
	 *
	...
	/**
	 * Searches through the BTree file to find a string and returns its
	 * frequency.
	 *
	 * @param qLine the string to be searched for
	 */
	private static int checkBTree(String qLine) {
		long key = GeneBankCreateBTree.convertToBinary(qLine);
	...
	private static void printUsage() {
		...
		System.out.println("debug level is set at 0.");
	}
}
