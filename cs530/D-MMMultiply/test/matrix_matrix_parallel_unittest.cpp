...
TEST(MatrixMatrixTest, one_by_one_zeros){
  ...
  struct Matrix *c = matrix_matrix_mult(a, a, 0, 3);
...
TEST(MatrixMatrixTest,twobytwo_times_twobytwo){
  ...
  struct Matrix *c = matrix_matrix_mult(a, b, 0, 3);
  ASSERT_FALSE(c==NULL);
...
TEST(MatrixMatrixTest, twobyone_twobyone){
  ...
  EXPECT_THROW(matrix_matrix_mult(a, b, 0, 3), std::exception);
...
TEST(MatrixMatrixTest, null_input_matrixa){
  ...
  ASSERT_THROW(matrix_matrix_mult(a, b, 0, 3), std::exception);
